...
export function OrderPageContainerLogic({ getAllStocks, saveOrder, saveOrdersResponse, getAllStocksResponse }: IOrderPageContainerProps) {
  ...
  }, [ticker, companyName, orderNature, orderType, quantity, limitPrice, saveOrder, getAllStocksResponse]);
